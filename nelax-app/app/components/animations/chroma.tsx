/*
 * @lev · OpenShaders
 * https://openshaders.com/@lev
 * WebGL2 · React component (TypeScript) · pixel
 *
 * import { LevShader } from "./LevShader.webgl.tsx";
 *
 * <LevShader theme="dark" style={{ width: 480, height: 300 }} />
 *
...
const float HUE = 0.554040372;
const float HUE_SPREAD = -0.162195638;
const float HUE_TRAVEL = 1.47662485;
const float CHROMA = 0.135932684;
const float LIGHTNESS = 0.489169478;
const float COLOUR_CYCLE = 0.216743588;
const float THETA = 2.13015962;
const float SHEAR = 0.962347567;
const float SHRINK = 0.959213793;
const float LAYERS = 90.0;
const float WARP_FREQ_X = 0.483676672;
const float WARP_FREQ_Y = 2.71919441;
const float WARP_AMP_X = 0.127022445;
const float WARP_AMP_Y = 0.022955684;
const float ASPECT_X = 1.73125398;
const float ASPECT_Y = 0.13438727;
const float OFFSET_X = 0.391294301;
const float OFFSET_Y = -0.0368215479;
const float TILT = -1.99013495;
const float ZOOM = 1.14440823;
const float CENTRE_X = -0.15426904;
const float CENTRE_Y = 0.687002718;
const float GLOW_SIZE = 0.00281762844;
const float FALLOFF = 0.289406598;
const float VIGNETTE = 0.11998976;
const float FLOW_SPEED = 0.414572954;
const float FLOW_DIRECTION = -1.0;
const float BREATH_RATE = 0.580548406;
const float BREATH_AMOUNT = 0.052396331;
const float PHASE = 50.730217;
const float ECHO = 0.0;
const float ECHO_SHIFT = 0.136064932;
const float SOFTNESS = 0.00267330604;
const float LIGHT_SWING = 0.235413626;
...
const float uStrength = 0.99838388;
const float uScale = 1.03592837;
const float uSeed = 0.40479508;
